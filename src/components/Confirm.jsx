...
const Confirm = ({ myData }) => {
  ...
  return (
    ...
    <div className="bg-white rounded-lg p-6 w-full h-full mt-52 md:w-1/3 md:h-auto md:mt-0">
                ...
                <div className="flex justify-between py-4 items-center">
                  <div className="flex items-center gap-4">
                    <div className="w-10 h-10">
                      <img className="rounded-md" src={item.image.thumbnail} alt={item.name} />
                    </div>
      ...
      <div>
        <button className="bg-Red w-full rounded-full py-4 mt-6 text-gray-100">
         Start New Order
        </button>
      </div>
    </div>
